...
require_relative '../../app/middleware/header_elevator'
...
Apartment.configure do |config|
  ...
  #
  config.excluded_models = %w[Account RestaurantSetting]
...
Rails.application.config.middleware.use HeaderElevator
